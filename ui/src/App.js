      ...
      <Grid container spacing={2} justifyContent="center" sx={{ my: 5 }}>
        ...
        <Grid item xs={3}>
          <Box>
            ...
            <Typography variant="body1" gutterBottom>Select table headings to sort &amp; filter. To submit a new record please <a href="https://github.com/TakesTheBiscuit/software-size-tool/issues/new" target="_blank">use the form on GitHub</a>.</Typography>
